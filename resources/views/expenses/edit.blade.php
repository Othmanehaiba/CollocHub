...
<div class="max-w-3xl mx-auto py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form method="POST" action="{{ route('colocations.expenses.update', [$colocation, $expense]) }}" class="p-8 space-y-6">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    >
                        @foreach($members as $membership)
                            <option value="{{ $membership->user->id }}" {{ old('paid_by', $expense->paid_by) == $membership->user->id ? 'selected' : '' }}>
