...
<head>
    ...
    <title>CollocHub – @yield('title', config('app.name', 'CollocHub'))</title>
...
<body class="h-full font-sans antialiased text-gray-900 bg-gray-50">
    <div class="min-h-screen flex flex-col">
        ...
        @else
            <!-- Basic Nav for Guests (e.g. login/register pages) -->
            <nav class="bg-white border-b border-gray-100">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            <div class="shrink-0 flex items-center">
                                <a href="{{ route('welcome') }}" class="text-xl font-bold text-indigo-600">
                                    CollocHub
                                </a>
                            </div>
                        </div>
            ...
            @if($errors->any())
                <div class="bg-red-50 border-l-4 border-red-400 p-4 rounded-md shadow-sm mb-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-red-800">Il y a eu {{ $errors->count() }} erreur(s) avec votre soumission</h3>
        ...
        @if (isset($header))
            <header class="bg-white shadow-sm mt-4 lg:mt-0">
